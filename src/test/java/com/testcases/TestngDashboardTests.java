...
public class TestngDashboardTests extends TestBase {
	...
	@Test(groups = {"regression", "smoke", "dashboard"})
	...
	public void shouldNavigateCorrectlyFromProfileMenuLinks() throws InterruptedException {
	...
	public void shouldNavigateToPunchInPageFromDashboard() throws InterruptedException {
		login().logMeInAsUser();
	...
	public void shouldNavigateToLeavePageFromDashboard() {
		login().logMeInAsUser();
		login().clickOnMenu("Dashboard");
	...
	public void shouldNavigateToMyTimesheetFromDashboard() {
		login().logMeInAsUser();
		login().clickOnMenu("Dashboard");
